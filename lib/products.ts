...
export const products: Product[] = [
  ...
  },
  {
    ...
    images: [`${bp}/images/hidratante.png`],
    featured: true,
  },
  {
  ...
  {
    id: 'kit-ritual-esencial',
    name: 'Kit Ritual Esencial — 3 productos',
    type: 'Kit de skincare',
    tagline: 'El primer paso hacia tu ritual',
    price: '$140.000',
    activeIngredients: ['Carbón Activado', 'Ácido Hialurónico', 'Extractos Botánicos'],
    shortDescription: 'Tres productos clave para comenzar tu rutina de cuidado facial con ingredientes de origen natural.',
    benefits: [
      'Rutina completa en tres pasos esenciales',
      'Combinación formulada para resultados visibles',
      'Ahorro frente a la compra individual',
      'Ideal como regalo o para iniciar tu ritual UNGUZY',
    ],
    skinType: 'Todo tipo de piel',
    usageMode: 'Seguir el modo de uso de cada producto incluido en el kit.',
    image: `${bp}/images/kit3.png`,
    images: [`${bp}/images/kit3.png`],
    featured: false,
  },
  {
    id: 'kit-ritual-completo',
    name: 'Kit Ritual Completo — 4 productos',
    type: 'Kit de skincare',
    tagline: 'Rutina balanceada para piel sana',
    price: '$180.000',
    activeIngredients: ['Carbón Activado', 'Vitamina C', 'Ácido Hialurónico', 'Extractos Botánicos'],
    shortDescription: 'Cuatro fórmulas seleccionadas para construir una rutina de cuidado facial equilibrada y efectiva.',
    benefits: [
      'Limpieza, tratamiento, hidratación y equilibrio en un solo kit',
      'Fórmulas complementarias entre sí',
      'Ahorro frente a la compra individual',
      'Experiencia de skincare completa desde el primer uso',
    ],
    skinType: 'Todo tipo de piel',
    usageMode: 'Seguir el modo de uso de cada producto incluido en el kit.',
    image: `${bp}/images/kit4.png`,
    images: [`${bp}/images/kit4.png`],
    featured: false,
  },
  {
    id: 'kit-ritual-premium',
    name: 'Kit Ritual Premium — 5 productos',
    type: 'Kit de skincare',
    tagline: 'Cuidado avanzado para resultados visibles',
    price: '$220.000',
    activeIngredients: ['Carbón Activado', 'Vitamina C', 'Colágeno', 'Ácido Hialurónico', 'Extractos Botánicos'],
    shortDescription: 'Cinco productos UNGUZY para una rutina facial completa de alto desempeño con ingredientes botánicos activos.',
    benefits: [
      'Cobertura integral de limpieza, tonificación, suero y nutrición',
      'Resultados visibles desde la primera semana',
      'Ahorro significativo frente a la compra individual',
      'La elección de quienes toman en serio su cuidado facial',
    ],
    skinType: 'Todo tipo de piel',
    usageMode: 'Seguir el modo de uso de cada producto incluido en el kit.',
    image: `${bp}/images/kit5.png`,
    images: [`${bp}/images/kit5.png`],
    featured: false,
  },
  {
    id: 'kit-ritual-total',
    name: 'Kit Ritual Total — Línea Completa',
    type: 'Kit de skincare',
    tagline: 'La experiencia UNGUZY completa',
    price: '$250.000',
    activeIngredients: ['Carbón Activado', 'Vitamina C', 'Colágeno', 'Elastina', 'Ácido Hialurónico', 'Niacinamida'],
    shortDescription: 'Los seis productos de la línea UNGUZY reunidos en un solo kit. La rutina de skincare natural más completa.',
    benefits: [
      'Línea completa UNGUZY: limpiador, dos tónicos, dos sérums y crema',
      'Cada fórmula diseñada para potenciar las demás',
      'El mayor ahorro de todo el catálogo',
      'El regalo perfecto — o el autocuidado definitivo',
    ],
    skinType: 'Todo tipo de piel',
    usageMode: 'Seguir el modo de uso de cada producto incluido en el kit.',
    image: `${bp}/images/kit6.png`,
    images: [`${bp}/images/kit6.png`],
    featured: false,
  },
]
